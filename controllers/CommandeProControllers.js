const CommandPro=require('../models/CommandPro');
...
exports.getcommandeByID=(req,res)=>{
    CommandPro.find({"user._id":req.params._id,},function (err,data) {
  if (err) {
      err.status = 406;
      return next(err);

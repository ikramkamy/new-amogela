...
<div className="item-user">{props.username}</div>      
  ...
  <div className="item-user" style={{textAlign:"center"}}><FaEye className="achat-list-icon"  onClick={handelshow}/>{showAchat &&(<AchatList product={props.product} cart={cart} showhendel={handelshow}/>)}</div>

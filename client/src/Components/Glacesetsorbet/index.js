...
<div>
    ...
    Nos glaces et sorbets se distinguent par leurs gouts et leurs saveurs fraiches, Pour y arriver nous avons le choix de les réaliser avec des ingrédients naturels, Privés de colorants et d'aromes de synthése,
     ...
     <div className="text-histoire">La liste des ingrédients qui compose nos recettes et la plus breve pioufle pour laisser la place à la vraie saveur des matiérs premiéres,</div> 
 ...
 <div className="text-histoire-wrapper">
 <div className="text-histoire"> Le choix des parfums commence par les classiques comme l vanille, le chocolat en passant les
